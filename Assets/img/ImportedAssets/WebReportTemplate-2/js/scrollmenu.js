...
function myIconeTuggle(e) {
  if (e == 'myIcone') {
    var ele = document.getElementById("menuList");
    var eleTwo = document.getElementById('myIcone');
    if (eleTwo.classList.contains('open')) {
      eleTwo.classList.remove('open');
    } else {
      eleTwo.classList.add('open');
    }
  } else if (e == 'interialList') {
    var ele = document.getElementById("intList");
  } else if (e == 'interialList-2') {
    var ele = document.getElementById("intList-2");
  }
